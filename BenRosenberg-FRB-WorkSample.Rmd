...
e2p %>%
  ...
  geom_label(hjust=0.1, vjust=1.5, size=3, alpha=0.7, position=position_dodge(width=1), label.size=NA) +
...
Since this statistic asks the reader to compare two proportions, I have instead opted for a bar graph with error bars.\
